...
@Component({
  selector: 'app-engine-coolant-temperature',
  templateUrl: './engine-coolant-temperature.component.html',
  styleUrls: ['./engine-coolant-temperature.component.scss']
})
export class EngineCoolantTemperatureComponent implements OnInit, AfterViewInit {
  @Input() value: any;
  @Input() name: any; 
  ...
  ngAfterViewInit()
  {
    ...
    var chart = am4core.create(`chartcoolanttemperature${this.name}`, am4charts.SlicedChart);
    ...
    */
    ...
    title2.text = "Engine Coolant Temperature"
    title2.fontSize = 20;
