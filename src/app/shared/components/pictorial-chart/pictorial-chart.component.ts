...
export class PictorialChartComponent implements OnInit, AfterViewInit {
  @Input() value: any;
  @Input() name: any; 
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create(`chartdiv${this.name}`, am4charts.SlicedChart);
    ...
    series.startLocation = 0.553 * (1- this.value/100);
    ...
    title.x = am4core.percent(this.value);
