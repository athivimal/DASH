...
@Component({
  selector: 'app-intake-manifold-absolute-pressure',
  templateUrl: './intake-manifold-absolute-pressure.component.html',
  styleUrls: ['./intake-manifold-absolute-pressure.component.scss']
})
export class IntakeManifoldAbsolutePressureComponent implements OnInit, AfterViewInit {
  @Input() value: any;
  @Input() name: any; 
...
let chart = am4core.create(`chartintakemanifold${this.name}`, am4charts.XYChart3D);
...
series2.columns.template.strokeWidth = 2;
    ...
    title.text = "Intake Manifold Absolute Pressure"
    title.fontSize = 20;
    title.fill = am4core.color("#390511");
    title.isMeasured = false;
    title.x = am4core.percent(-1);
